...
module.exports = class BStats extends Command {
	...
	run(bot, message) {
		...
		const embed = new MessageEmbed()
			.setAuthor("Aldebarman  |  Bot Statistics", bot.user.avatarURL())
			.setDescription(
				"Multiple informations about Aldebarman are shown on this page, mainly the used ressources and the global usage statistics."
			)
